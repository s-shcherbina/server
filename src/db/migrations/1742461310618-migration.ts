...
export class Migration1742461310618 implements MigrationInterface {
    name = 'Migration1742461310618'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "company_actions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP NOT NULL DEFAULT now(), "ownerVerdict" boolean NOT NULL, "userVerdict" boolean NOT NULL, "role" integer DEFAULT '100', "user_id" uuid, "company_id" uuid, CONSTRAINT "PK_7b32a0edc0d3aeaa7373c4d955e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "answers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP NOT NULL DEFAULT now(), "correct" boolean NOT NULL, "text" character varying NOT NULL, "element_id" uuid, CONSTRAINT "PK_9c32cec6c71e06da0254f2226c6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "quiz_results" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP NOT NULL DEFAULT now(), "questions" integer NOT NULL DEFAULT '0', "correct_answers" integer NOT NULL DEFAULT '0', "member_questions" integer NOT NULL DEFAULT '0', "member_correct_answers" integer NOT NULL DEFAULT '0', "user_questions" integer NOT NULL DEFAULT '0', "user_correct_answers" integer NOT NULL DEFAULT '0', "user_id" uuid, "quiz_id" uuid, "company_id" uuid, CONSTRAINT "PK_4ecf38c5bf5b054ccc9f10e438a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "quizzes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "description" character varying NOT NULL, "frequency" integer NOT NULL, "valid" boolean NOT NULL DEFAULT false, "company_id" uuid, CONSTRAINT "PK_b24f0f7662cf6b3a0e7dba0a1b4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "quiz_results" ADD CONSTRAINT "FK_74c27ccc120fd5a0968737c645b" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "quiz_results" ADD CONSTRAINT "FK_a5e1e00cb1e36eec2dfa2c21065" FOREIGN KEY ("quiz_id") REFERENCES "quizzes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "quiz_results" ADD CONSTRAINT "FK_4d5825dc5b3e053ec650aecf895" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "quizzes" ADD CONSTRAINT "FK_3ea83aabeb8ce48f5659d337d37" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "quizzes" DROP CONSTRAINT "FK_3ea83aabeb8ce48f5659d337d37"`);
        await queryRunner.query(`ALTER TABLE "quiz_results" DROP CONSTRAINT "FK_4d5825dc5b3e053ec650aecf895"`);
        await queryRunner.query(`ALTER TABLE "quiz_results" DROP CONSTRAINT "FK_a5e1e00cb1e36eec2dfa2c21065"`);
        await queryRunner.query(`ALTER TABLE "quiz_results" DROP CONSTRAINT "FK_74c27ccc120fd5a0968737c645b"`);
